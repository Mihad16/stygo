...
const fashionCategories = [
  { name: "Men", color: "from-blue-100 to-blue-300 text-blue-900", image: "/images/men.png" },
  { name: "Women", color: "from-pink-100 to-pink-300 text-pink-900", image: "/images/women.png" },
  { name: "Kids", color: "from-yellow-100 to-yellow-300 text-yellow-900", image: "/images/kids.png" },
  { name: "Beauty", color: "from-purple-100 to-purple-300 text-purple-900", image: "/images/beauty.png" },
  { name: "Accessories", color: "from-green-100 to-green-300 text-green-900", image: "/images/accessories.png" },
];
      ...
      <div className="mb-10 p-6 border border-gray-100">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div className="w-full lg:w-1/2">
            <Search value={searchTerm} onChange={setSearchTerm} placeholder="Search shops or locations..." />
          </div>
              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  {shop.logo ? (
                    ...
                    <div className="flex-shrink-0 w-14 h-14 rounded-lg bg-gray-100 flex items-center justify-center text-gray-400">🏪</div>
                  )}
