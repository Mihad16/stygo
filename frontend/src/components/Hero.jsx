...
export default function Hero() {
  return (
    <div className="min-h-[420px] sm:min-h-[500px] md:min-h-[600px] flex flex-col items-center justify-center px-4 py-10 text-center relative overflow-hidden bg-neutral-50 border-b border-gray-200">
      {/* 3D-like floating elements with subtle shadows */}
      ...
      {/* Main content with embossed text effect */}
      <div className="max-w-sm sm:max-w-md md:max-w-lg mx-auto px-2 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button className="bg-white hover:bg-gray-50 text-gray-800 font-medium py-3 px-6 rounded-lg transition-all shadow-sm hover:shadow-md border border-gray-200 active:scale-[0.98] text-sm sm:text-base">
            Start Selling Free
          </button>
